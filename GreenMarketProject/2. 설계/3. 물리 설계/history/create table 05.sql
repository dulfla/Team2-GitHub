...
BEGIN
    IF INSERTING THEN
        ...
        VALUES(memberTracking_seq.NEXTVAL, :NEW.p_id,:NEW.regdate, 'IN'); -- sysdate 여야 함
    ELSIF DELETING THEN
        INSERT INTO memberHistory
        VALUES(memberTracking_seq.NEXTVAL, :OLD.p_id,:OLD.regdate, 'OUT'); -- sysdate 여야 함
    END IF;
END memberAdmin;
...
CREATE OR REPLACE TRIGGER productAdmin01
BEFORE INSERT
    ON trade
FOR EACH ROW
DECLARE
...
BEGIN
    ...
    VALUES(memberTracking_seq.NEXTVAL, :NEW.p_id, dayDate, 'TRADE'); -- sysdate 여야 함
END memberAdmin;

CREATE OR REPLACE TRIGGER productAdmin02
BEFORE INSERT OR DELETE
    ON product
FOR EACH ROW
DECLARE
...
BEGIN
    ...
    IF INSERTING THEN
        INSERT INTO productHistory
        VALUES(memberTracking_seq.NEXTVAL, :NEW.email, dayDate, 'IN');
    ELSIF DELETING THEN
        INSERT INTO productHistory
        VALUES(memberTracking_seq.NEXTVAL, :OLD.email, dayDate, 'OUT'); -- :OLD.regdate가 sysdate 여야 함
    END IF;
END memberAdmin;
