      ...
      <div class="input-form col-md-12 mx-auto">
		...
		<div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="number" class="form-control" id="birth" placeholder="ex 19970518" ng-required="true" ng-maxlength="8" required required>
            <div class="invalid-feedback">
            	생년월일을 입력해주세요.
            </div>
          </div> 
          ...
          <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="phone" placeholder="하이픈 없이 입력" required>
            <div class="invalid-feedback">
            	전화번호를 입력해주세요.
            </div>
          </div> 
